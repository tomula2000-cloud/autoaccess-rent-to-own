    ...
    <PortalMobileShell>
      ...
      <div className="px-4 pt-1 pb-2">
        <a
          ...
          className="flex items-center gap-2.5 rounded-[14px] border border-[#d59758]/30 bg-gradient-to-r from-[#fbf2ea] to-white px-3.5 py-2.5 shadow-[0_2px_8px_-2px_rgba(213,151,88,0.15)]"
        >
          <div className="flex items-center gap-0.5">
            {[1,2,3,4,5].map((i) => (<svg key={i} width="11" height="11" viewBox="0 0 24 24" fill="#d59758"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2" /></svg>))}
          </div>
          <span className="text-[11px] font-semibold text-[#c37d43]">4.7 &bull; 229+ reviews on SA Reviews</span>
          <svg className="ml-auto h-3 w-3 text-[#d59758]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><line x1="5" y1="12" x2="19" y2="12" /><polyline points="12 5 19 12 12 19" /></svg>
        </a>
      </div>
