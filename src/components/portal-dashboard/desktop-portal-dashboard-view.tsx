          ...
          <div className="rounded-[26px] bg-white p-5 md:p-7">
              ...
              <div className="group relative overflow-hidden rounded-[22px] border border-[#e1e4ee] bg-white p-5 shadow-[0_6px_18px_-8px_rgba(15,23,42,0.1)] transition hover:border-[#2f67de]/30 hover:shadow-[0_12px_30px_-12px_rgba(47,103,222,0.2)]">
                ...
                <div className="relative flex items-start gap-3">
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <p className="mt-1.5 break-words font-mono text-[1rem] font-semibold text-[#1b2345]">
                      {application.referenceNumber}
                    </p>
                  </div>
                </div>
            ...
            approvalValidUntilIso ? (
              <div className="mt-5">
                <ApprovalCountdownCard
                  approvalValidUntil={approvalValidUntilIso}
                />
              </div>
            ) : null}
              ...
              <div className="mt-5 grid gap-5 xl:grid-cols-[0.95fr_1.05fr]">
                  ...
                  <div className="p-5 sm:p-6">
                    <div className="overflow-hidden rounded-[18px] border border-[#e7eaf2] bg-[#fafbff]">
                      {application.contractVehicleImage ? (
                        <div className="overflow-hidden bg-[#f4f6fb]">
                          <img
                            src={application.contractVehicleImage}
                            alt={application.contractVehicleTitle || "Vehicle"}
                      ...
                      <div className="p-4">
                        ...
                        <p className="mt-2 text-lg font-semibold text-[#1b2345]">
                        ...
                        <div className="mt-3 flex flex-wrap gap-2">
                          ...
                          {application.contractTerm && (
                            <span className="rounded-full border border-emerald-200 bg-emerald-50 px-3 py-1 text-[10px] font-bold uppercase tracking-[0.16em] text-emerald-700">
                              {application.contractTerm} months
                            </span>
                          )}
                        </div>
                      </div>
                    ...
                    <div className="mt-4 rounded-[18px] border border-[#f1dfd1] bg-gradient-to-r from-[#fbf2ea] to-white p-4">
                      ...
                      <p className="mt-2 text-sm leading-6 text-[#39425d]">
                        Your contract has been formally issued and your
                        completion stage is now active. The original approval
                        period no longer applies from this point forward.
                      </p>
                      <p className="mt-3 text-sm leading-6 text-[#39425d]">
                        A strict{" "}
                        <span className="font-semibold text-[#1b2345]">
                          24-hour completion window
                        </span>{" "}
                        is now active. You are required to review the full
                        contract, complete the digital acceptance below and
                        fulfil all outstanding payment requirements within this
                        period.
                      </p>
                      <p className="mt-3 text-sm leading-6 text-[#39425d]">
                        Failure to complete within the active contract period may
                        result in the expiry or cancellation of your contract
                        stage, which could affect the outcome of your
                        application.
                      </p>
                    </div>
                ...
                <div className="overflow-hidden rounded-[24px] border border-[#e1e4ee] bg-white shadow-[0_8px_24px_-12px_rgba(15,23,42,0.08)]">
                  ...
                  <div className="p-5 sm:p-6">
                    ...
                    <form
                      action="/api/portal/accept-contract"
                      method="POST"
                      className="mt-5 space-y-4"
                    >
                      <label className="flex cursor-pointer items-start gap-3 rounded-[16px] border border-[#e1e4ee] bg-[#fafbff] p-4 transition hover:border-[#d59758]/50 hover:bg-[#fffaf5]">
                        <input
                          type="checkbox"
                          name="acceptedTerms"
                          value="yes"
                          required
                          className="mt-0.5 h-4 w-4 shrink-0 cursor-pointer accent-[#d59758]"
                        />
                        <span className="text-sm leading-6 text-[#39425d]">
                          I confirm that I have read and reviewed the full
                          Vehicle Rental Agreement and that I understand my
                          contract has been formally issued with a strict{" "}
                          <span className="font-semibold text-[#1b2345]">
                            24-hour completion window
                          </span>
                          . I acknowledge that failure to complete within this
                          period may result in the expiry or cancellation of my
                          contract stage.
                        </span>
                      </label>
                      ...
                      <label className="flex cursor-pointer items-start gap-3 rounded-[16px] border border-[#e1e4ee] bg-[#fafbff] p-4 transition hover:border-[#d59758]/50 hover:bg-[#fffaf5]">
                        ...
                        />
                        <span className="text-sm leading-6 text-[#39425d]">
                          I have reviewed and confirm that my personal details
                          and selected vehicle information on record are correct
                          and accurately reflect my application.
                        </span>
                      </label>
                      ...
                      <div className="rounded-[16px] border border-[#e1e4ee] bg-white p-4">
                        ...
                        <p className="mt-1 text-xs leading-5 text-[#68708a]">
                          Type your full legal name below to act as your digital
                          signature and confirm your acceptance of this contract.
                        </p>
                        <input
                          type="text"
                          id="acceptedName"
                          ...
                          className="mt-3 w-full rounded-[10px] border border-[#dbe0ed] bg-[#fafbff] px-4 py-3 text-sm font-medium text-[#1b2345] placeholder-[#a3aac0] outline-none ring-0 transition focus:border-[#d59758] focus:ring-2 focus:ring-[#d59758]/20"
                        />
                      </div>

                      <div className="rounded-[16px] border-l-4 border-[#2f67de] bg-gradient-to-r from-[#eef4ff] to-white p-4">
                        <p className="text-[10px] font-bold uppercase tracking-[0.18em] text-[#2f67de]">
                          Important Notice
                        </p>
                        <p className="mt-2 text-sm leading-6 text-[#39425d]">
                          By submitting this form you are digitally accepting
                          the terms of your issued Vehicle Rental Agreement. Your
                          acceptance will be securely recorded along with a
                          timestamp and your full name as provided above.
                        </p>
                        <p className="mt-2 text-sm leading-6 text-[#39425d]">
                          Upon successful contract acceptance, your application
                          will move to{" "}
                          <span className="font-semibold text-[#1b2345]">
                            Awaiting Invoice
                          </span>
                          . Your invoice will be released later by admin, and
                          only then will payment instructions appear in your
                          portal.
                        </p>
                      </div>
                      ...
                      <button
                        type="submit"
                        className="inline-flex w-full items-center justify-center gap-2 rounded-full bg-gradient-to-r from-[#d59758] to-[#c37d43] px-6 py-4 text-sm font-semibold text-white shadow-[0_14px_30px_-10px_rgba(213,151,88,0.55)] transition hover:from-[#c37d43] hover:to-[#b86e35] hover:shadow-[0_16px_36px_-10px_rgba(213,151,88,0.7)]"
                      >
                        <svg
                          className="h-4 w-4"
                          viewBox="0 0 24 24"
            ...
            {isContractIssued && isContractAccepted ? (
              <div className="mt-5 overflow-hidden rounded-[24px] border border-emerald-200 bg-gradient-to-br from-emerald-50 via-white to-green-50 shadow-[0_8px_24px_-12px_rgba(16,185,129,0.15)]">
                <div className="border-b border-emerald-100 bg-gradient-to-r from-[#0a3b2a] to-[#0f5239] px-5 py-4 sm:px-6">
                ...
                <div className="p-5 sm:p-6">
                  <div className="flex items-start gap-5">
                    <div className="flex h-14 w-14 shrink-0 items-center justify-center rounded-2xl bg-gradient-to-br from-emerald-500 to-emerald-700 text-white shadow-[0_10px_24px_-8px_rgba(16,185,129,0.55)]">
                      <svg
                        className="h-7 w-7"
                        viewBox="0 0 24 24"
                        fill="none"
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <p className="mt-2 text-sm leading-6 text-[#4d546a]">
                        Your digital contract acceptance has been recorded and
                        securely timestamped. No further action is required at
                        this step.
                      </p>
                      <p className="mt-2 text-sm leading-6 text-[#4d546a]">
                        Your application has now moved to{" "}
                        <span className="font-semibold text-[#1b2345]">
                          Awaiting Invoice
                        </span>
                        . Please continue checking your portal while our team
                        prepares and releases your invoice.
                      </p>
                      {application.contractAcceptedName ? (
                        <p className="mt-4 text-[11px] font-semibold uppercase tracking-[0.18em] text-emerald-700">
                          Signed by{" "}
            ...
            {isAwaitingInvoice ? (
              <div className="mt-5 space-y-5">
                  ...
                  <div className="p-5 sm:p-6">
                    <div className="flex items-start gap-5">
                      ...
                      <div className="min-w-0 flex-1">
                        ...
                        <p className="mt-2 text-sm leading-6 text-[#4d546a]">
                          Your digital contract acceptance has been recorded and
                          securely timestamped. Your application is now awaiting
                          the release of your invoice by our team.
                        </p>
                        {application.contractAcceptedName ? (
                          <p className="mt-4 text-[11px] font-semibold uppercase tracking-[0.18em] text-emerald-700">
                            Signed by{" "}
                ...
                <div className="overflow-hidden rounded-[24px] border border-[#f1dfd1] bg-gradient-to-br from-[#fffaf5] via-white to-[#fbf2ea] shadow-[0_8px_24px_-12px_rgba(213,151,88,0.15)]">
                  <div className="border-b border-[#f1dfd1] bg-gradient-to-r from-[#1b2345] to-[#2a3563] px-5 py-4 sm:px-6">
                    <p className="text-[10px] font-bold uppercase tracking-[0.22em] text-[#f4c89a]">
                      Next Milestone
                    </p>
                    <h2 className="text-[1.05rem] font-semibold text-white sm:text-[1.15rem]">
                  ...
                  <div className="p-5 sm:p-6">
                    <div className="flex items-start gap-4">
                      <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl bg-gradient-to-br from-[#d59758] to-[#c37d43] text-white shadow-[0_10px_24px_-8px_rgba(213,151,88,0.45)]">
                        <svg
                          width="22"
                          height="22"
                          viewBox="0 0 24 24"
                      ...
                      <div className="min-w-0 flex-1">
                        ...
                        <p className="mt-2 text-sm leading-6 text-[#39425d]">
                          Your contract acceptance has been completed. Our team
                          is now preparing your invoice. Once the invoice is
                          released, further payment instructions and details will
                          appear in your portal.
                        </p>
                        <p className="mt-3 text-sm leading-6 text-[#39425d]">
                          No further action is required from you at this stage.
                          Please continue checking your portal for the next
                          update.
                        </p>
                      </div>
                    </div>
                  ...
                  <div className="overflow-hidden rounded-[24px] border border-[#e1e4ee] bg-white shadow-[0_8px_24px_-12px_rgba(15,23,42,0.08)]">
                    ...
                    <div className="p-5 sm:p-6">
                      <div className="overflow-hidden rounded-[18px] border border-[#e7eaf2] bg-[#fafbff]">
                        ...
                        <div className="p-4">
                          ...
                          {displayVehicleMileage ? (
                            <div className="mt-4 rounded-[14px] border border-[#eef0f7] bg-white px-4 py-3">
                              <p className="text-[10px] font-bold uppercase tracking-[0.18em] text-[#68708a]">
                                Mileage
                              </p>
                      ...
                      <div className="mt-4 rounded-[18px] border border-[#f1dfd1] bg-gradient-to-r from-[#fbf2ea] to-white p-4">
                        ...
                        <p className="mt-2 text-sm leading-6 text-[#39425d]">
                          Your invoice has now been released. Please review the
                          full payment summary and follow the official payment
                          guidance shown in your portal.
                        </p>
                        <p className="mt-3 text-sm leading-6 text-[#39425d]">
                          Always use the correct reference number{" "}
                          <span className="font-semibold text-[#1b2345]">
                            {application.referenceNumber}
                          </span>{" "}
                          when preparing payment so your transaction can be
                          linked correctly to your application.
                        </p>
                      </div>
                    </div>
                  </div>
                      ...
                      <div className="rounded-[18px] border border-[#f1dfd1] bg-gradient-to-r from-[#fffaf5] to-white p-4">
                        ...
                        <div className="mt-3 space-y-3 text-sm leading-6 text-[#39425d]">
                          <p>
                            ...
                            Follow only the approved invoice payment instructions
                            provided by Auto Access.
                          </p>
                          <p>
                            <span className="font-semibold text-[#1b2345]">
                              Payment Reference:
                            </span>{" "}
                            Use your application reference{" "}
                            <span className="font-mono font-semibold text-[#1b2345]">
                              {application.referenceNumber}
                            </span>{" "}
                            exactly as shown.
                          </p>
                          <p>
                            ...
                            Ensure your payment details are entered correctly so
                            verification can be completed without delays.
                          </p>
                          <p>
                            <span className="font-semibold text-[#1b2345]">
                              Timing Note:
                            </span>{" "}
                            Keep proof of payment ready after completing your
                            transaction, as it may be required during review and
                            verification.
                          </p>
                        </div>
                      </div>

                      <div className="rounded-[18px] border-l-4 border-[#2f67de] bg-gradient-to-r from-[#eef4ff] to-white p-4">
                        <p className="text-[10px] font-bold uppercase tracking-[0.18em] text-[#2f67de]">
                          Proof of Payment Guidance
                        </p>
                        <p className="mt-2 text-sm leading-6 text-[#39425d]">
                          Once payment has been made, keep your proof of payment
                          ready for the verification stage. Upload or submission
                          handling can be completed in the next build step if
                          not yet enabled in this portal.
                        </p>
                      </div>

                      <div className="rounded-[18px] border border-[#f1dfd1] bg-[#fbf2ea] px-4 py-3">
                        <p className="text-[10px] font-bold uppercase tracking-[0.18em] text-[#c37d43]">
                          Current Status
                        </p>
                        <p className="mt-1 text-sm font-semibold text-[#1b2345]">
                ...
                <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                  <div>
                    <p className="text-[10px] font-bold uppercase tracking-[0.2em] text-emerald-700">
                      Vehicle Selection Open
                    </p>
                    <h3 className="mt-2 text-lg font-semibold text-[#1b2345]">
                      Your approval is active. You can now choose your vehicle.
                    </h3>
                    <p className="mt-2 max-w-2xl text-sm leading-6 text-[#4d546a]">
                      Only qualifying vehicle options should be selected before
                      your approval period expires. Continue now to review your
                      available options and proceed to the next completion stage.
                    </p>
                  </div>
                ...
                <div className="overflow-hidden rounded-[24px] border border-[#e1e4ee] bg-white shadow-[0_8px_24px_-12px_rgba(15,23,42,0.08)]">
                  ...
                  <div className="p-5 sm:p-6">
                    ...
                    <div className="mt-4 rounded-[18px] border border-[#f1dfd1] bg-gradient-to-r from-[#fbf2ea] to-white p-4">
                      ...
                      <p className="mt-2 text-sm leading-6 text-[#39425d]">
                        Your contract request has been submitted successfully and
                        is now awaiting admin review.
                      </p>
                      <p className="mt-3 text-sm leading-6 text-[#39425d]">
                        The strict 24-hour completion countdown has{" "}
                        <span className="font-semibold text-[#1b2345]">
                          not started yet
                        </span>
                        . It will only begin once the contract is formally
                        issued by admin.
                      </p>
                      <p className="mt-3 text-sm leading-6 text-[#39425d]">
                        Please remain ready to proceed promptly once the contract
                        is issued.
                      </p>
                    </div>
                  </div>
                ...
                <div className="overflow-hidden rounded-[24px] border border-[#e1e4ee] bg-white shadow-[0_8px_24px_-12px_rgba(15,23,42,0.08)]">
                  ...
                  <div className="space-y-4 p-5 sm:p-6">
                    ...
                    <div className="rounded-[18px] border-l-4 border-[#d59758] bg-gradient-to-r from-[#fbf2ea] to-white p-4">
                      ...
                      <p className="mt-2 text-sm leading-6 text-[#39425d]">
                        Once the contract is issued, the earlier approval window
                        will fall away and the formal contract timeline will
                        govern the transaction.
                      </p>
                      <p className="mt-3 text-sm leading-6 text-[#39425d]">
                        Please ensure you remain ready with{" "}
                        <span className="font-semibold text-[#1b2345]">
                          {formatCurrency(totalRequiredNow)}
                        </span>{" "}
                        for deposit and licensing/registration, while your first
                        monthly instalment of{" "}
                        <span className="font-semibold text-[#1b2345]">
                          {formatCurrency(selectedVehicleMonthly)}
                        </span>{" "}
                        remains payable next calendar month.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex items-center justify-between gap-3">
                  <div className="flex items-center gap-3">
                    <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-white/10 backdrop-blur">
                      <svg
                        className="h-4.5 w-4.5 text-[#f4c89a]"
                        width="18"
                        height="18"
                        viewBox="0 0 24 24"
                        fill="none"
                  ...
                  <span className="hidden rounded-full border border-white/20 bg-white/10 px-3 py-1 text-[10px] font-bold uppercase tracking-[0.18em] text-white backdrop-blur sm:inline-flex">
                    {isAwaitingInvoice
                      ? "Awaiting Admin"
                      : isInvoiceIssued
                      ? "Payment Required"
                ...
                !isInvoiceIssued ? (
                  <div className="rounded-[18px] border border-[#e4e7f0] bg-white p-4 sm:p-5">
                    <div className="flex items-start gap-3">
                      <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-[#eef4ff] text-[#2f67de]">
                        <svg
                          width="16"
                          height="16"
                          viewBox="0 0 24 24"
                    ...
                    <div className="relative flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                      <div className="flex items-start gap-4">
                        ...
                        <div>
                          ...
                          <p className="mt-1.5 text-sm leading-6 text-[#1b2345] sm:text-[15px]">
                            Please choose your vehicle option to proceed with
                            the next stage of your approved application.
                          </p>
                        </div>
                      </div>
                    ...
                    <div className="relative flex items-start gap-4">
                      <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl bg-gradient-to-br from-[#d59758] to-[#c37d43] text-white shadow-[0_10px_24px_-8px_rgba(213,151,88,0.45)]">
                        ...
                        >
                          ...
                          <path d="M21 12c.55 0 1 .45 1 1v6a2 2 0 01-2 2H4a2 2 0 01-2-2v-6c0-.55.45-1 1-1" />
                      ...
                      <div className="min-w-0 flex-1">
                        ...
                        <p className="mt-1.5 text-sm leading-6 text-[#1b2345] sm:text-[15px]">
                          Your contract request is now awaiting admin review and
                          issue. The strict 24-hour completion window has not
                          yet started and will only begin after the contract is
                          formally issued.
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="relative flex items-start gap-4">
                      <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl bg-gradient-to-br from-[#d59758] to-[#c37d43] text-white shadow-[0_10px_24px_-8px_rgba(213,151,88,0.45)]">
                        <svg
                          ...
                          strokeLinejoin="round"
                        >
                          <path d="M21 15V8a2 2 0 00-2-2H7l-4 4v9a2 2 0 002 2h14a2 2 0 002-2z" />
                          <path d="M3 10h4a2 2 0 002-2V4" />
                        </svg>
                      </div>
                      <div className="min-w-0 flex-1">
                        <p className="text-[10px] font-bold uppercase tracking-[0.18em] text-[#c37d43]">
                        ...
                        <p className="mt-1.5 text-sm leading-6 text-[#1b2345] sm:text-[15px]">
                          Payment is now required. Review the invoice guidance,
                          use the correct reference number, and keep proof of
                          payment ready for the next verification stage.
                        </p>
                      </div>
                    </div>
                  </div>
            ...
            <div className="mt-6 grid gap-5 lg:grid-cols-[0.95fr_1.05fr]">
              <div className="overflow-hidden rounded-[24px] border border-[#e1e4ee] bg-white shadow-[0_8px_24px_-12px_rgba(15,23,42,0.08)]">
                <div className="flex items-center justify-between gap-3 border-b border-[#eef0f7] px-5 py-4 sm:px-6">
                  <div className="flex items-center gap-3">
                    <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-gradient-to-br from-[#2f67de] to-[#4f86f7] text-white shadow-[0_8px_18px_-6px_rgba(47,103,222,0.5)]">
                      <svg
                        width="16"
                        height="16"
                        viewBox="0 0 24 24"
                    ...
                    <div>
                      ...
                      <h2 className="text-[1.02rem] font-semibold text-[#1b2345] sm:text-[1.1rem]">
                        Applicant Summary
                      </h2>
                    </div>
                  </div>
                  ...
                  <Link
                    ...
                    className="inline-flex items-center gap-1.5 rounded-full bg-gradient-to-r from-[#2f67de] to-[#3f78ea] px-4 py-2 text-xs font-semibold text-white shadow-[0_10px_18px_-6px_rgba(47,103,222,0.45)] transition hover:from-[#2559c6] hover:to-[#3568d6]"
                  >
                    Documents
                    <svg
                      width="12"
                ...
                <div className="divide-y divide-[#eef0f7]">
                  <div className="flex items-start gap-4 px-5 py-4 sm:px-6">
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <p className="mt-1 break-words text-sm font-semibold text-[#1b2345]">
                  ...
                  <div className="flex items-start gap-4 px-5 py-4 sm:px-6">
                    <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-orange-50 text-[#d59758]">
                      <svg
                        width="14"
                        height="14"
                        viewBox="0 0 24 24"
              ...
              <div className="overflow-hidden rounded-[24px] border border-[#e1e4ee] bg-white shadow-[0_8px_24px_-12px_rgba(15,23,42,0.08)]">
                <div className="flex items-center justify-between gap-3 border-b border-[#eef0f7] px-5 py-4 sm:px-6">
                  <div className="flex items-center gap-3">
                    <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-gradient-to-br from-[#d59758] to-[#e4ad72] text-white shadow-[0_8px_18px_-6px_rgba(213,151,88,0.5)]">
                      <svg
                        width="16"
                        height="16"
                        viewBox="0 0 24 24"
                ...
                <div className="p-5 sm:p-6">
                  {application.documents.length > 0 ? (
                      ...
                      <div className="relative flex items-start gap-4">
                        ...
                        <div className="min-w-0 flex-1">
                          ...
                          <p className="mt-1 text-sm leading-6 text-[#4d546a]">
                            <span className="text-2xl font-semibold tabular-nums text-[#1b2345]">
                    ...
                    <div className="rounded-[20px] border-2 border-dashed border-[#d7d9e2] bg-gradient-to-br from-[#fafbff] to-white p-6 text-center">
                      ...
                      <p className="mt-3 text-sm font-semibold text-[#1b2345]">
                        No documents submitted yet
                      </p>
                      <p className="mt-1 text-sm leading-6 text-[#68708a]">
                        Upload your required files to continue.
                      </p>
                    </div>
                  )}
                </div>
              ...
              <div className="flex items-center justify-between gap-3 border-b border-[#eef0f7] px-5 py-4 sm:px-6">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <h2 className="text-[1.05rem] font-semibold text-[#1b2345] sm:text-[1.15rem]">
                      Progress Journey
                    </h2>
                  </div>
                </div>
                {application.statusLogs.length > 0 ? (
                  <span className="inline-flex items-center gap-1.5 rounded-full border border-[#dbe6ff] bg-[#eef4ff] px-3 py-1 text-[10px] font-bold uppercase tracking-[0.18em] text-[#2f67de]">
                    {application.statusLogs.length} Update
                    {application.statusLogs.length === 1 ? "" : "s"}
                  </span>
                ) : null}
              </div>
              ...
              <div className="p-5 sm:p-6">
                {application.statusLogs.length === 0 ? (
                  ...
                  <div className="relative space-y-5">
                    ...
                    {application.statusLogs.map((log, index) => {
                      ...
                      return (
                        <div key={log.id} className="relative flex gap-4">
                          ...
                          <div
                            className={`min-w-0 flex-1 rounded-[18px] border p-4 transition ${
                              isLatest
                          ...
                          >
                            <div className="flex flex-col gap-2 sm:flex-row sm:items-start sm:justify-between">
                              <div className="min-w-0">
                                ...
                                <p className="mt-1 break-words text-xs text-[#68708a]">
                                  {new Date(log.createdAt).toLocaleString()}
                                </p>
                              </div>

                              <span
                                className={`inline-flex w-fit shrink-0 items-center gap-1.5 rounded-full px-3 py-1 text-[10px] font-bold uppercase tracking-[0.18em] ${
                                  isLatest
